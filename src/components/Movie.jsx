        ...
        <div key={itens.id} className="card mt-3 pl-2 pt-3 pb-3 pr-2">
          <div className="row">
            ...
            <div className="col-md-6">
              ...
              <span className="nascimento">
                Data de nascimento: {itens.nascimento}
              </span>
            </div>
          </div>
        </div>
            ...
            <div className="col-md-10">
              <div className="row">
                ...
                <div className="col-md-8">
                  <div className="row justify-content-space-between linha-estrela">
                    <h2 className="movie-title">{movie}</h2>
                    <img src={estrela} alt="rating" className="estrela" />
                  </div>
